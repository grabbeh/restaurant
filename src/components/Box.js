...
const StyledBox = styled.div`
  transform-origin: 0;
  ${boxShadow} ${borders} ${space} ${size} ${maxWidth} ${minWidth} ${transform} ${skew} ${width} ${height} ${fontWeight} ${fontSize} ${color} ${borderRadius} ${position} ${top} ${bottom} ${left} ${right} ${zIndex} ${borderColor};
`
